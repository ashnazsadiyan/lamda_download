...
def download_stream(interview: Interview):
    try:
        ...
        # Analyze speech rate
        speech_rate = len(waveform) / sample_rate  # Speech rate in seconds
        words = len(interview.text_data.split())
        ...
        # return {"words_per_minute": string_words_per_minute, "Voice_pitch": string_mean_pitch, "sentiment_score":
        # sentiment_score, "string_grammar_score": string_grammar_score }
        return {
            "speech_rate": str(speech_rate),
            "mean_pitch": str(mean_pitch),
            "sentiment_score": sentiment_score,
            "string_grammar_score": str(grammar_score),
            "words_per_minute": string_words_per_minute,
            "Voice_pitch": string_mean_pitch,
        }
